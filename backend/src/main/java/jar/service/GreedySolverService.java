...
public class GreedySolverService {
     ...
     * This project’s backend is intended to implement only Divide & Conquer logic.
     * The original greedy implementation is preserved below as commented reference.
     */
    public QueensSolution solveGreedy(int n, List<Integer> regions) {
        return new QueensSolution(
            new ArrayList<>(),
            false,
            "Greedy solver is disabled. Use the Minimax-based Divide & Conquer solver instead."
        );
    }

    /**
     * GREEDY AI MOVE (DISABLED):
     * This backend uses Minimax DnC for AI move selection.
     */
    public int getGreedyMove(GameState gameState) {
        return -1;
    }
}

// =====================================================================
// Original greedy implementation (commented out per requirements)
// =====================================================================
// package jar.service;
//
// import jar.model.GameState;
...
//
//     /**
//      * Get greedy AI move for the game
//      */
//     public int getGreedyMove(GameState gameState) {
...
//
//         // For each valid move, evaluate how many future moves it leaves
...
//
//     /**
//      * Evaluate a move by counting how many safe positions remain after placing a queen
//      */
//     private int evaluateMove(GameState gameState, int position) {
//         // Create temporary state with the new queen
...
//                 int pos = row * n + col;
//                 if (isSafe(tempQueens, pos, n, gameState.getRegions())) {
//                     safeCount++;
//                 }
//             }
//         }
...
//                 if (isSafe(gameState.getQueenPositions(), position, n, gameState.getRegions())) {
...
//
//     /**
//      * Check if a position is safe (no attacks from existing queens and region constraint)
//      */
...
//
//         // Check if any existing queen is in the same region
//         for (int queenPos : queenPositions) {
...
//         }
//
//         // Check row, column, and diagonal attacks
//         for (int queenPos : queenPositions) {
//             int qRow = queenPos / n;
//             int qCol = queenPos % n;
//
